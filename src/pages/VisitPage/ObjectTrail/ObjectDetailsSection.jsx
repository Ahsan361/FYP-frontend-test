            ...
            <Grid size={{sm:14, md:8}}>
                ...
                >
                    ...
                    <Typography variant="body1"
                        ...
                        Our trails will take you on fascinating tours, highlighting the most popular objects on display and covering a variety of themes.
                    </Typography>
                    <Typography variant="body1"
                        sx={{
                            fontSize: { xs: "0.9rem", sm: "1rem", md:"1.5rem" },
                        ...
                        Please note a small number of galleries remain closed and you will not be able to view objects within them.
                    </Typography>
                </Box>
            </Grid>
            {/* {Right Column} */}
