        ...
        <Grid container >
            ...
            <Grid size={{sm:14, md:8}}>
                ...
                >
                    ...
                    >
                        Explore the Museum and enjoy incredible cultures from around the world.
                    </Typography>                    
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        ...
                        >
                            <Typography sx={{fontSize: {xs:"0.9rem", sm:"1rem", md:"1.5rem"}}}>
                                Text alternative to Museum map
                            </Typography>
                        </Button>
                        <Button 
                            variant="contained" 
...
export default MuseumDetailsSection;
