        ...
        <Grid container sx= {{py:4, px:8}} >
            ...
            <Grid size={{xs: 12, sm: 12, md: 4}} sx={{backgroundColor:theme.palette.divider}}>
                ...
                <Typography
                    ...
                    >
                    Add a touch of history to your mantlepiece with replicas, sculptures and reproductions based on art and objects in the Museum's collection
                </Typography>
                </Box>
            </Grid>
        </Grid>
