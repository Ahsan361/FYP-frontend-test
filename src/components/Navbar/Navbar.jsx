...
import { StyledAppBar, StyledDrawer, StyledListItem } from "./StyledComponents";
    ...
    <StyledAppBar>
      <Toolbar sx={{ minHeight: 72, px: { xs: 2, sm: 3, lg: 4 }, justifyContent: "space-between" }}>
        ...
        <Box sx={{ flex: 1 }} onClick={(e) => e.stopPropagation()}>
          <DesktopNavigation navItems={navItems} openDropdown={openDropdown} setOpenDropdown={setOpenDropdown} />
        </Box>
        <RightActions 
          user={user} 
          isMobile={isMobile}
